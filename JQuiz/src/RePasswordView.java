...
public class RePasswordView extends javax.swing.JFrame {

    /**
     * Creates new form rePasswordView
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please enter your username, full name, and E-mail");
        ...
        kGradientPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(btnSubmit, javax.swing.GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RePasswordView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RePasswordView().setVisible(true);
            }
        });
    }
